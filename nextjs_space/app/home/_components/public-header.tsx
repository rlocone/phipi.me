'use client';
import { Shield, Home, Clock, BookOpen, Rss } from 'lucide-react';
    ...
    <header className="bg-gray-900/90 backdrop-blur-sm border-b border-purple-500/20 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <nav className="flex items-center space-x-6">
          ...
          <Link href="/history" className="text-gray-300 hover:text-purple-400 transition-colors flex items-center gap-1">
