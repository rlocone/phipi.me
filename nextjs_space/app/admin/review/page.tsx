      ...
      {loading ? (
        ...
        <div className="space-y-4">
          {articles?.map?.((article) => (
            <div key={article.id} className="bg-gray-800/50 border border-purple-500/20 rounded-lg p-6">
              <div className="flex justify-between">
                <div className="flex-1">
                  ...
                  {article.aiSummary && <p className="text-gray-400 mb-3">{article.aiSummary}</p>}
